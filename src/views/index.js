    ...
    <div className={styles['container']}>
      ...
      <div className={styles['Top-container']}>
        ...
        <div className={styles['Hero']}>
          <h1
            className={` ${styles['text09']} ${projectStyles['heading']} ${projectStyles['text-shadow']} `}
          >
            Michael Furman
          </h1>
          <div className={styles['Content-container']}>
            <h2
              className={` ${styles['Subheading']} ${projectStyles['subheading']} ${projectStyles['text-shadow']} `}
            >
      ...
      <div id="main-section" className={styles['Main']}>
        ...
        <div className={styles['Cards-container']}>
          <PlaceCard
            city="IOKDS New Donors &amp; Members"
            image="/playground_assets/iokds%20nafi-300h.jpg"
            description="The International Order of the King's Daughters and Sons required a video showing their gratitude for new members and donors."
            rootClassName="rootClassName1"
          ></PlaceCard>
          <PlaceCard
            city="Momma's Home Rebranding"
            image="/playground_assets/momma's%20home%20soap-300h.jpg"
            description="Momma's Home Handcrafted Soaps and Oils launched a rebranding campaign during 2020, advertising their community outreach."
            rootClassName="rootClassName"
          ></PlaceCard>
          <PlaceCard
            city="Monologue Projects:    Sarah Tuma"
            image="/playground_assets/2022-04-11-300h.png"
            description="Sarah Tuma required a monologue recorded for a class project for the University of Evansville."
          ></PlaceCard>
          <PlaceCard
            city="Photography Portfolio"
            image="/playground_assets/ireland6-300h.jpg"
            description="Pictures taken for projects, "
          ></PlaceCard>
          <PlaceCard
            city="Social Media/Marketing Management"
            image="/playground_assets/just%20another%20day-300h.jpg"
          ></PlaceCard>
          <PlaceCard
            city="Other Projects"
            image="/playground_assets/close%20up-300h.jpg"
            description="Projects made for fun, for college classes, or for testing different videography themes and methods"
          ></PlaceCard>
        </div>
      </div>
      <div className={styles['Footer']}>
        <div className={styles['Menu']}>
          <h1 className={styles['Logo2']}>Contact:</h1>
